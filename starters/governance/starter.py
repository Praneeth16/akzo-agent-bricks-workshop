...
# MAGIC
# MAGIC *Hackathon track #4. Forkable Day-2 starter — a slim distillation of `L200-capabilities/04_trust_and_governance.py`
# MAGIC + `L200-capabilities/04_trust_and_governance.py`.*
# MAGIC
...
# MAGIC by `L200-capabilities/04_trust_and_governance.py` (idempotent re-seed here keeps the starter self-contained).
...
# MAGIC lag clears). Preseeded by `L200-capabilities/04_trust_and_governance.py`.
